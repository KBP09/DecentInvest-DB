...
import { investmentABIFull } from "../abis/investmentABI";
...
const getChainConfig = (address: string, action: string): Record<number, ChainConfig> => ({
  80002: {
    url: `https://api.etherscan.io/v2/api?chainid=80002&module=account&action=${action}&address=${address}${
      action === 'tokentx'
  ...
  // 11155111: {
  //   url: `https://api.etherscan.io/v2/api?chainid=11155111&module=account&action=${action}&address=${address}${
  //     action === 'tokentx'
